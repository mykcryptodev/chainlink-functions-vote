  ...
  .setAction(async (taskArgs, hre) => {
    ...
    await new Promise(async (resolve) => {
      ...
      client.on("OCRResponse", async (eventRequestId, result, err) => {
        ...
        console.log("chainlink consumer address", client.address)

        // check storage variables
        // const proposalOutcome = await clientContract.proposals("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7")
        // console.log(`proposal outcome: ${proposalOutcome}`)

        // check if the proposal has completely executed
        // const proposalExecuted = await clientContract.hasCompletelyExecuted("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7")
        // console.log(`proposal executed: ${proposalExecuted}`)

        // check the tx index to execute
        // const txIndex = await clientContract.txIndexToExecute("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7")
        // console.log(`tx index: ${txIndex}`)

        // console.log proposal bytes
        // const propBytes = await clientContract.proposals("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7")
        // console.log(`proposal bytes: ${propBytes}`)
        ...
        // const test = await clientContract.test("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7");
        // console.log(`test: ${test}`)

        //execute the proposal
        const exec = await clientContract.executeProposal(
          "0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7",
        ...
        console.log(`exec done: ${execDone}`)

        // check storage variables again
        const proposalOutcomeAfter = await clientContract.proposals("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7")
        console.log(`proposal outcome after: ${proposalOutcomeAfter}`)


        // check if the proposal has completely executed
        const proposalExecutedAfter = await clientContract.hasCompletelyExecuted("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7")
        console.log(`proposal executed: ${proposalExecutedAfter}`)

        // check the tx index to execute
        const txIndexAfter = await clientContract.txIndexToExecute("0x9f600d89afee092554afb9ae6c7dfc63c4123245b02f89237aa7e1ca0a31c3f7")
